...
# Backward-compatible fallback if Terminal1 was started before this runner was updated.
...
LOG="$ROOT/output/tray_integrated_v2_12"; mkdir -p "$LOG"
...
echo '============================================================'
echo '[BASE READY V2.12.1] both map_servers ACTIVE + same-direction 3m convoy + crossing/head-on traffic avoidance'
