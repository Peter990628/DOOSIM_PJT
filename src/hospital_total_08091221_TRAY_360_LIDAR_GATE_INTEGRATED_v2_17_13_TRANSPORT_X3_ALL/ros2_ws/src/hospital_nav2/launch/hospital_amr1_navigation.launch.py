    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                output="screen",
                # V2.12: never force the historical docking-station coordinates.
                # The initializer below feeds the exact current Isaac world pose.
                parameters=[params_file, {"use_sim_time": use_sim_time, "auto_initial_pose": False}],
            ),
            Node(
                package="hospital_nav2",
                executable="world_pose_initializer",
                name="world_pose_initializer",
                output="screen",
                parameters=[{
                    "use_sim_time": use_sim_time,
                    "robot_name": "AMR1",
                    "world_pose_topic": "/amr1/world_pose",
                    "initialpose_topic": "/initialpose",
                    "lock_topic": "/initial_pose_locked",
                    "fixed_pose_enabled": False,
