...
LOG="$CACHE_ROOT/terminal1_v216.log"
...
echo '================================================================='
echo '[V2.16 SCAN-STRAIGHT EXTERNAL SSD SAFE - TERMINAL 1]'
...
echo 'START     : AMR1 + AMR2 scan-ready, DETACHED, exact bay centerlines'
echo "SESSION=$SESSION"
echo "LOG=$LOG"
echo '================================================================='

set +e
"$PY" "$ROOT/tray_overlay/scripts/isaac_amr_ros_tray_scan_straight_v216.py" \
  --project-root "$ROOT" \
