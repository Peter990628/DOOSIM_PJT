...
def navigation_include(nav2_share: Path, namespace: str, use_sim_time, params_file):
    ...
    # ROS 2 Humble navigation_launch.py uses namespace for the YAML root key, but
    # does not namespace its Node actions. Apply the namespace outside the include.
    if namespace:
        return GroupAction(actions=[PushRosNamespace(namespace), include])
    return include
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[params_amr1, {
                ...
                'traffic_pause_topic': '/traffic_pause',
            }],
        ),
        ...
        Node(
            ...
            parameters=[params_amr2, {
                ...
                'corner_stop_sec': 0.60,
                'final_stop_sec': 0.25,
                'rotate_before_segment': True,
                'rotate_max_speed_rad_s': 0.70,
                'rotate_min_speed_rad_s': 0.12,
                'rotate_kp': 1.00,
